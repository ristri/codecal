    ...
    return (
      <View style={styles.holder}>
        <View style={styles.imageContainer}>
          <CardsImage email={this.props.name.creator.email} />
        </View>
        ...
        <View style={styles.container}>
          ...
          <Text>
            ...
            {moment(this.props.name.start.dateTime).format(
              'D MMMM YYYY HH:mm Z'
            )}
          </Text>
          <Text>
            <Text style={styles.endDate}>End Date:</Text>{' '}
            {moment(this.props.name.end.dateTime).format('D MMMM YYYY HH:mm Z')}
          </Text>
